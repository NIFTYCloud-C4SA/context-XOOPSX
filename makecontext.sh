...
${BIN_CURL} -o ${PATH_WORKDIR}/tmp_wordpress.tar.gz ${URL_ARCHIVE}
${BIN_TAR} zxf ${PATH_WORKDIR}/tmp_wordpress.tar.gz -C ${PATH_WORKDIR}/
${BIN_MV} ${PATH_WORKDIR}/wordpress*/* ./contexts/krm/public_html/
${BIN_RM} ${PATH_WORKDIR}
